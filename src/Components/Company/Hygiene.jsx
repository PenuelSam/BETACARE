...
const Hygiene = () => {
  ...
  return (
    <div className="mb-20">
      ...
      <div className="flex items-center justify-end sm:justify-start lg:items-start lg:flex-col-reverse lg:gap-10 gap-52 ">
        <div data-aos="zoom-in" className="w-[581px] sm:w-[340px] lg:pl-10 sm:h-[1700px] h-[1227px] flex flex-col items-center mt-10 justify-center lg:justify-start ">
          <p className="font-[300] text-right lg:text-left text-[24px] lg:text-[20px] leading-[37.92px] sm:leading-[35px] lg:tracking-normal tracking-[0.1px] text-[#363637]">
          ...
          <p className="font-[300] text-right lg:text-left text-[24px] lg:text-[20px] leading-[37.92px] sm:leading-[35px] lg:tracking-normal tracking-[0.1px] text-[#363637] mt-10">
